...
% title({'$c=5$'},'Interpreter','LaTeX','FontSize',20) % c=5
% title({'$c=10$'},'Interpreter','LaTeX','FontSize',20) % c=10
% title({'$c=20$'},'Interpreter','LaTeX')  % c=20
...
%
axis([0 50 2.35 2.5])  % c=1
% axis([0 50 5.2 6.2])  % c=5
% axis([0 50 8.5 11])  % c=10
% axis([0 50 15 21])  % c=20

set(gca,'FontSize',22)

set(gca,'LooseInset',get(gca,'TightInset'))
%
print -depsc hyp_per_UB_1 % c1
% print -depsc hyp_per_UB_5 % c5
% print -depsc hyp_per_UB_10 % c10
% print -depsc hyp_per_UB_20 % c20
%%